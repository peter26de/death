...
function shot() {
	const sound = new Audio("https://raw.githubusercontent.com/peter26de/death/main/shot.wav");
	sound.play();
}
function redOrb() {
	const sound = new Audio("https://raw.githubusercontent.com/peter26de/death/main/red orb.wav");
	sound.play();
}
function blackOrb() {
	const sound = new Audio("https://raw.githubusercontent.com/peter26de/death/main/black orb.wav");
	sound.play();
}
...
function initAudio() {
	...
	async function initAudioBack() {
		const player = new Tone.Player({
			url: "https://raw.githubusercontent.com/peter26de/death/main/clock.wav",
			loop: true,
